    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 group">
          ...
          <a
            href="#"
            className="flex flex-col md:flex-row md:items-center md:gap-2 leading-none"
          >
            <span className="text-lg md:text-xl font-black tracking-tight text-white uppercase italic opacity-90">
              GTU-SET's
            </span>

            <span className="text-xl md:text-2xl font-black tracking-tight text-[#FFCC00] uppercase italic whitespace-nowrap">
